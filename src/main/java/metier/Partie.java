...
public class Partie {
	...
	public int initPartie(int nbJoueur, Compte connected, Partie p)
	{
		for(int i = 0;i<nbJoueur;i++)
		{
			...
			{
				System.out.println("\nJoueur 1 : ");
				System.out.println("\nBienvenue "+connected.getPrenom()+" "+connected.getNom()+", vous �tes le Joueur 1, quelle chance ! ");
			...
			{
				System.out.println("\nJoueur "+(i+1)+" : ");
				String compteCree = saisieString("Ce joueur a-t-il d�j� un compte ? (y/n)");
				...
				if(compteCree.equalsIgnoreCase("y"))
				{
					...
					System.out.println("\nBienvenue "+j.getPrenom()+" "+j.getNom()+", vous �tes le Joueur "+(i+1)+" ! ");
